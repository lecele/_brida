...
const app = express();
const PORT = 3001;
const N8N_URL = process.env.N8N_WEBHOOK_URL || 'https://katrina-publications-costs-traveler.trycloudflare.com/webhook/76481988-7d5a-4a82-a6ef-bffad0b029c3/chat';
